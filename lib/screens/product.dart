...
import 'package:credible_steel/models/Cate.dart';
import 'package:credible_steel/screens/subcatepage.dart';
  ...
  Widget build(BuildContext context) {
    ...
    MaterialPageRoute(builder: (context) => SubCatePage(snapshot.data[index].cateId),
        ...
        return GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index){
              return gridcontainer(snapshot.data[index].cateName, snapshot.data[index].cateUrl,snapshot.data[index].cateId);
          });
          },
        ),
        //when not
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text("No Category to show !",style: GoogleFonts.montserrat(color:Colors.green,fontSize: 26.0),)
              ],
            ),
          ))
      ],)
