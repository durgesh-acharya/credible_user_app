...
import 'package:credible_steel/models/Prod.dart';
import 'package:credible_steel/models/ProdImg.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Card(
                          ...
                          child: Center(child: Icon(Icons.error_outline,color: Colors.red,size: 40.0,),
                        ),
                      )),
                    ),
                  ],
            ...
            child: Container(
                    height: 225.0,
                    child: Center(child:Text("No similar products !!",style: GoogleFonts.secularOne(color:Colors.red,fontSize: 24.0),)
                          ),
                  ),)
